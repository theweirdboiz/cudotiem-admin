              ...
              <div className="flex items-center justify-center">
                <TooltipOption icon={<IconOption />}>
                  <ul className="text-start">
                    <li className="block hover:bg-primary hover:bg-opacity-10 px-3 py-1 rounded-lg text-primary">
                      <Link>View</Link>
                    </li>
                    <li className="block hover:bg-primary hover:bg-opacity-10 px-3 py-1 rounded-lg">
                      <Link>Edit</Link>
                    </li>
                    <li className="block hover:bg-primary hover:bg-opacity-10 px-3 py-1 rounded-lg">
                      <Link>Delete</Link>

...
const SideUpPage = (props) => {
  ...
  return (
    <>
      <h3 className="font-semibold text-3xl text-center mb-5 dark:text-white">
        Sign Up
      </h3>
      ...
      <button className="flex items-center justify-center py-3 gap-x-3 w-full border border-strock rounded-xl text-text-2 dark:text-white text-base font-semibold mb-5">

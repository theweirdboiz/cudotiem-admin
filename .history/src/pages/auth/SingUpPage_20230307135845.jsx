...
import { Label, Input, FormGroup, Button } from "@components";
    ...
    <>
      ...
      <form action="" onSubmit={handleSubmit(onSubmit)} autoComplete="off">
        ...
        <div className="flex items-start gap-x-5 mb-5">
          <span className="inline-block w-5 h-5 border border-text-4 rounded-md"></span>
        ...
        <Button className="w-full bg-primary" type="submit" disable>
          Create my account
        </Button>
      </form>
    </>

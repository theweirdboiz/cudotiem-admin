    ...
    <section>
      <div className="mt-10">
        ...
        <div className="flex mb-5 gap-x-5 text-[14px]">
          <button className="bg-btn-primary px-4 py-2 rounded-md font-semibold text-white uppercase hover:bg-btn-primary-hover">
            new
          </button>
          <button className="bg-btn-primary px-4 py-2 rounded-md font-semibold text-white uppercase  hover:bg-btn-primary-hover">
            export csv
      ...
      <div className="border rounded-md">
        <div className="flex items-center justify-between p-4 border-b font-semibold">
          <Checkbox control={control} name="user" />
        ...
        <UserRow userInf={userInf} control={control}></UserRow>
        <UserRow userInf={userInf} control={control}></UserRow>
        <UserRow userInf={userInf} control={control}></UserRow>
      </div>
    </section>

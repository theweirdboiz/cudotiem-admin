...
const Input = ({ control, error = "", placeholder, children, ...props }) => {
  ...
  return (
    <div className="relative">
      <input
        id={props.name}
        className={`w-full border border-strock dark:border-darkStroke rounded-xl py-4 px-6 font-medium text-sm text-text-1 placeholder:text-text-4 bg-transparent ${

    ...
    <div className="flex items-center gap-x-3">
      <label
        ...
        className={classNames(
          "inline-flex items-center justify-center text-white w-5 h-5 rounded border cursor-pointer transition-all",
          isChecked ? "bg-primary border-primary" : "bg-white border-text-4"
        )}
      >

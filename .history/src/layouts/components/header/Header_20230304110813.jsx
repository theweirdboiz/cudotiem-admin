...
const Header = (props) => {
  ...
  return (
    <header
      className={`fixed shadow-xl px-8 flex items-center justify-between left-[240px] right-0 bg-white z-50`}
    >
      ...
      <div className="flex items-center gap-x-4 text-xl text-gray font-semibold">
        <button>
          <BsSun />
        </button>
        <button>

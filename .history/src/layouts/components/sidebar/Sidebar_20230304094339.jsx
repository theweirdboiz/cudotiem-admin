      ...
      <div className="border-r h-full border-r-border-color">
        ...
        <ul className="mt-2 px-3">
          <li
            ...
            className={`text-black hover:text-primary-color capitalize group`}
          >
            <Link
              to={"/"}
              className={`flex items-center gap-x-3 px-3 py-2 group-hover:bg-primary-color group-hover:bg-opacity-10 rounded-lg w-full font-semibold ${
          ...
          >
            <Link
              to={"/post"}
              className={`flex items-center gap-x-3 px-3 py-2 group-hover:bg-opacity-10 rounded-lg w-full font-semibold ${
                itemActived === "post" &&
                "text-primary-color bg-primary-color bg-opacity-10"
              }`}
            >

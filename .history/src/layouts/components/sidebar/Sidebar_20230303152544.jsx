...
const SidebarItem = ({ icon, route }) => {
  return (
    <li className="flex text-gray hover:text-black capitalize group">
      <a
        href={route.path}
        className="flex gap-x-10 px-10 py-2 group-hover:bg-primary-color group-hover:bg-opacity-10 w-full"
      >
        {icon}
